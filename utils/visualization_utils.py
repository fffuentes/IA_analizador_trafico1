...
Estas funciones a menudo reciben una imagen, realizan alguna visualización en la imagen.
Las funciones no devuelven un valor, en su lugar modifican la imagen en sí.
...
# image utils - image saver 
from utils.image_utils import image_saver

#  predicted_speed predicted_color module
