...
def color_recognition(crop_img):
    ...
    crop_img = crop_image.crop_center(crop_img, 50, 50)  #recorte la imagen del vehículo detectada y obtenga una pieza de la imagen desde el centro
    ...
    color_histogram_feature_extraction.color_histogram_of_test_image(crop_img)  # Enviar pieza de imagen para el color del vehículo.
