...
# cálculo de la distancia euclidead
...
# obtener k los vecinos mas cercanos
...
# Cargar datos de características de la imagen en vectores de características de entrenamiento y vectores de características de prueba
def loadDataset(
    filename,
    filename2,
...
def main(training_data, test_data):
    training_feature_vector = []  # vector de características de entrenamiento
    test_feature_vector = []  # vector de características de prueba
    loadDataset(training_data, test_data, training_feature_vector, test_feature_vector)
    classifier_prediction = []  # prediccion
    k = 3  # Valor k del k vecino más cercano
